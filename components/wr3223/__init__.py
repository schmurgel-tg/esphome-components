...
WR3223 = wr3223_ns.class_("WR3223", cg.Component, uart.UARTDevice)
...
async def to_code(config):
    ...
    # Polling-Komponente direkt in `WR3223` speichern
    #cg.add(var.set_sensor_polling_component(polling_component))

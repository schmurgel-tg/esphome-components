...
public:
  // Abtau ein, beginn Abtauung ab Verdampfertemperatur. Temperatur
  // lesen/schreiben
  static constexpr const char *AE = "AE";

  // Abtau aus, ende Abtauung ab Verdampfertemperatur. Temperatur
  // lesen/schreiben
  ...
  // Parameter, ERDluft +S1, Drehzahlerhöhung Zuluftventilator Stufe 1, wenn
  // Erdwärmetauscher ein (0% bis 40%)
  static constexpr const char *E1 = "E1";

  // Parameter, ERDluft +S2, Drehzahlerhöhung Zuluftventilator Stufe 2, wenn
  // Erdwärmetauscher ein (0% bis 40%)
  static constexpr const char *E2 = "E2";

  // Parameter, ERDluft +S3, Drehzahlerhöhung Zuluftventilator Stufe 3, wenn
  // Erdwärmetauscher ein (0% bis 40%)
  static constexpr const char *E3 = "E3";

  // Parameter, LuflREDUK, Luftwechsel um 3% reduziert ab Außentemp. ...°C
  // (-20°C bis +10°C)
